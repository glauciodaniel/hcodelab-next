...
export default function ourHistory(){
    ...
    return (
        <>
            <Header />
            <main id={styles.ourHistory} className={ styles.page}>
            <div className={styles.pageHeader}>
                <header class={styles.headerText}>
                    <ul className={styles.ulText}>
                        <li className={styles.liText}>#legado</li>
                    </ul>
                    <h1  className={styles.h1Text}>Nossa História</h1>
                </header>
                <hr className="italy" />
            </div>
