...
const handleClick = ()=>{
    ...
    <>
        ...
        <header id={styles.header}>
                <div id={ styles.overlay} data-close="menu" onClick={handleClick}></div>
                ...
                <button type="button" id={ styles['btn-close']} data-close="menu" className={styles[open]} onClick={handleClick}>
